async function drawMap() {
  ...
  const countryShapes = await d3.json("./../world-geojson3.json");
  ...
  const countries = bounds
    ...
    .attr("fill", d => {
      const metricValues = metricDataByCountry[countryIdAccessor(d)];
      if (typeof metricValues == "undefined") return "#e2e6e9";
      return colorScale(metricValues);
    });
